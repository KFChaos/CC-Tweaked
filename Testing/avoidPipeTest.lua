...
function layer(size)
    ...
    -- SEND CURRENT INFORMATION ABOUT WHICH LAYER IT IS ON
    digUp()
    clearInv()
    if stillFull(5) then
        xProgress = xCoord
